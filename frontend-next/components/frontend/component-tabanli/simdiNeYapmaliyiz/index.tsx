        ...
        <div className="">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="px-6 pt-6">
              ...
              <p>
                JavaScript ekosistemi, modern web geliştirmenin temelini oluşturan geniş bir
                teknoloji ve araç setidir. npm (Node Package Manager) üzerinden erişilebilen yüz
                binlerce paket, framework ve kütüphane ile web uygulamaları geliştirebilirsiniz.
                Node.js ile sunucu tarafında da çalışabilen JavaScript, tam kapsamlı web projeleri
                geliştirmenize olanak tanır. <span>TypeScript</span> ise JavaScript&#39;e tip
                güvenliği ekleyen, Microsoft tarafından geliştirilen üst seviye bir programlama
                dilidir. Nesne yönelimli programlama özellikleri ve gelişmiş IDE desteği ile
                kurumsal projelerde tercih edilir.
              </p>
            </div>
            <div className="p-6">
