export default function Tanim() {
  return (
    <section>
      ...
      <div>
        <p>
          Component tabanlı geliştirme yaklaşımı, modern frontend uygulamalarının vazgeçilmez bir
          parçasıdır. Bu yaklaşım, kullanıcı arayüzünü bağımsız, yeniden kullanılabilir ve bakımı
          kolay parçalara bölerek geliştirme sürecini daha verimli hale getirir. Her bir component,
